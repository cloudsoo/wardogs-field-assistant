const CACHE='wardogs-field-v31';
const CORE=['./','./index.html','./app.js','./app-v19.js','./map-v22.js','./map-v22-fix.js','./map-v27-fix.js','./field-enhance-v31.js','./page-switch-fix.js','./manifest.json','./icon.svg'];
