...
const core=document.createElement('script');core.src='./app-v19.js?v=21';core.dataset.boot='wardogs-v21-core';
core.onload=()=>{const map=document.createElement('script');map.src='./map-v21.js?v=21';map.dataset.boot='wardogs-v21-map';document.head.appendChild(map)};
