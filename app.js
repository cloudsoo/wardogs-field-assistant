...
const core=document.createElement('script');core.src='./app-v11.js?v=16';core.dataset.boot='wardogs-v11';
core.onload=()=>{const style=document.createElement('script');style.src='./map-v14-style.js?v=16';style.dataset.boot='wardogs-map-v14-style';style.onload=()=>{const map=document.createElement('script');map.src='./map-v14-fix.js?v=16';map.dataset.boot='wardogs-map-v14';document.head.appendChild(map)};document.head.appendChild(style)};
