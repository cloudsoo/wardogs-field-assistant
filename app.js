...
const core=document.createElement('script');core.src='./app-v19.js?v=23';core.dataset.boot='wardogs-v23-core';
core.onload=()=>{const map=document.createElement('script');map.src='./map-v22.js?v=23';map.dataset.boot='wardogs-v23-map';map.onload=()=>{const fix=document.createElement('script');fix.src='./map-v22-fix.js?v=23';fix.dataset.boot='wardogs-v23-fit-fix';document.head.appendChild(fix)};document.head.appendChild(map)};
