...
const core=document.createElement('script');core.src='./app-v19.js?v=22';core.dataset.boot='wardogs-v22-core';
core.onload=()=>{const map=document.createElement('script');map.src='./map-v22.js?v=22';map.dataset.boot='wardogs-v22-map';document.head.appendChild(map)};
