...
// Detach controls before legacy app-v11 binds its old Leaflet map listeners.
for(const id of ['nav2','mapSelect']){const old=$(id);if(old){const fresh=old.cloneNode(true);old.replaceWith(fresh)}}
const core=document.createElement('script');core.src='./app-v11.js?v=14';core.dataset.boot='wardogs-v11';core.onload=()=>{const style=document.createElement('script');style.src='./map-v14-style.js?v=14';style.dataset.boot='wardogs-map-v14-style';style.onload=()=>{const map=document.createElement('script');map.src='./map-v14-fix.js?v=14';map.dataset.boot='wardogs-map-v14';document.head.appendChild(map)};document.head.appendChild(style)};document.head.appendChild(core);
})();